...
.controller('UserCtrl', function($scope, TemplateService, NavigationService, $timeout, $stateParams, $state) {
    //Used to name the .html file
...
.controller('UserNotificationCtrl', function($scope, TemplateService, NavigationService, $timeout) {
    ...
    $scope.search = function() {
        NavigationService.searchUserNotification($scope.pagedata, function(data) {
            ...
            $scope.totalItems = data.data.totalpages;
        });
    };
...
.controller('headerctrl', function($scope, TemplateService, $location, NavigationService, $timeout, toastr, $uibModal) {
